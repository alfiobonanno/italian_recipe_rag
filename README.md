...
An intelligent conversational assistant powered by Retrieval-Augmented Generation (RAG) that helps you discover, modify, and create authentic Italian recipes. Built with local LLMs using Ollama, ChromaDB vector storage, and a Gradio interface.
